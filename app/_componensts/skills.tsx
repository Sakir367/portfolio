        ...
        <div className=' w-full flex  lg:flex-row lg:flex-wrap  justify-center flex-col gap-10'>
          <div className="flex flex-col items-center ">
            ...
            <div className="flex justify-between w-[260] lg:w-[320px] mt-2">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="px-5 py-2 border text-[#2e2828] dark:text-[#ABB2BF] text-[12px] lg:text-[14px] rounded-md">
                  HTML
                </div>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex justify-between w-[260] lg:w-[340] mt-2">
              ...
              <div className="flex flex-col items-center">
                <div className="w-0.5 h-6 flow-vertical"></div>
                <div className="px-3 lg:px-5 py-2 text-[#2e2828] dark:text-[#ABB2BF] text-[12px] lg:text-[14px] border rounded-md">
                  React.js
                </div>
              </div>
              ...
              <div className=" flex flex-col items-center">
                ...
                <div className="px-3 lg:px-5 py-2 text-[#2e2828] dark:text-[#ABB2BF] border text-[12px] lg:text-[14px] rounded-md">
                  Tailwind CSS
                </div>
              </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex justify-between w-[260] lg:w-[320px] mt-2">
              ...
              <div className="flex flex-col items-center">
                <div className="w-0.5 h-6 flow-vertical"></div>
                <div className="px-5 py-2 text-[12px] text-[#2e2828] dark:text-[#ABB2BF] lg:text-[14px] border rounded-md">
                  Git
                </div>
              </div>
